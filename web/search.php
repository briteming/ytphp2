  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
       ...
       <div class="row"> <div class="col-md-12 selectalign">  Custom Search： <select class="custom-select" id="paixu">
        <?php
             switch ($order1){
                    case 'relevance':
                      $relevance='selected';
             ...
             echo '<option '.$channel.' data-url="./ajax/ajax.php?q='.$q.'&type=channel&order=relevance&ptk='.$_GET['pageToken'].'">Search in channel only</option>';
        ?>
          </select></div></div>
