    ...
    <div class="row">
        <div class="col-md-8 col-sm-12 col-xs-12 col-lg-8 leffix">
            ...
            <div class="vinfo fsize2 clearfix">
                ...
                <span class="pull-left ">Catergory<a href="./content.php?cont=category&sortid=<?php echo $videodata['items']['0']['snippet']['categoryId']?>" class="pl-2 d-inline"  target="_blank"><?php echo categorieslist($videodata['items']['0']['snippet']['categoryId'])?></a>
                </span>
