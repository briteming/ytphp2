...
case 'category':
	...
	break;
case 'trending':
    $headtitle='Trending Now'.'-'.SITE_NAME;
	break;
case 'DMCA':
...
case 'video':
	...
	break;
case 'api':
    $headtitle='API Setting'.'-'.SITE_NAME;
	break;
         ...
         <div class="col-md-9 relatedlist">
            ...
            switch ($cont) {
		        ...
		        echo '<div id="videocont"></div>
            		...
            		echo '<option '. $relevance .' data-url="./ajax/ajax.php?type=category&sortid='.$sortid.'&ptk='.$ptk.'">Popular</option>';
            		echo '<option ' . $date1 .' data-url="./ajax/ajax.php?type=category&sortid='.$sortid.'&order=date&ptk='.$ptk.'">Lastest</option>';
            		echo '<option ' . $viewCount .' data-url="./ajax/ajax.php?type=category&sortid='.$sortid.'&order=viewCount&ptk='.$ptk.'">Most watched</option>';
            		echo '</select></div></div>';
